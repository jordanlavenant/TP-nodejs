...
exports.RankingModule = RankingModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([_entitiesplayer_entity_1.Player]), event_emitter_1.EventEmitterModule.forRoot()],
        providers: [ranking_service_1.RankingService, _playerplayer_service_1.PlayerService],
